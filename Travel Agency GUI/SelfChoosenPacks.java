        ...
        cb1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (s == 0) {
                    ...
                    cb2.addItem("Goa");
                    cb2.addItem("Manali");
                    cb2.addItem("Kerala (Munnar)");
                    cb2.addItem("Shimla");
                    cb2.addItem("Darjeeling");
                    cb2.enable();
                    cb5.removeAllItems();
                    cb5.addItem("Choose hotel type...");
                    cb5.addItem("Lodge (₹2,000)");
                    cb5.addItem("Motel (₹3,500)");
                    cb5.addItem("Local (₹5,000)");
                    cb5.addItem("3 Star Hotel (₹8,000)");
                    cb5.addItem("5 Star Hotel (₹12,000)");
                    cb5.enable();
                    cb6.removeAllItems();
                    cb6.addItem("Travel By...");
                    cb6.addItem("Train");
                    cb6.addItem("Bus");
                    cb6.addItem("Airplane (₹12,000)");
                    cb6.enable();
                    cb7.removeAllItems();
                    cb7.addItem("Select vehicle first!");
                    cb7.enable();
        ...
        cb6.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (s == 0) {
                    ...
                    cb7.addItem("AC Sleeping Couch (₹750)");
                    cb7.addItem("AC Seating Couch (₹520)");
                    cb7.addItem("AC Train (₹440)");
                    cb7.addItem("Non-AC Train (₹250)");
                    cb7.enable();
                } else if (s == 2) {
                    cb7.removeAllItems();
                    cb7.addItem("Select bus type...");
                    cb7.addItem("AC Bus (₹2,500)");
                    cb7.addItem("Non-AC Bus (₹900)");
                    cb7.enable();
                } else if (s == 3) {
                    cb7.removeAllItems();
                    cb7.addItem("No different types available...");

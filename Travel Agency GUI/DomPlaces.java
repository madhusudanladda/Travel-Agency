...
public class DomPlaces extends JFrame {
    ...
    DomPlaces() {
        ...
        place2 = new JRadioButton("Manali");
        ...
        place3 = new JRadioButton("Kerala (Munnar)");
        ...
        place4 = new JRadioButton("Shimla");
        ...
        place5 = new JRadioButton("Darjeeling");
        ...
        btn3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                if (place == 1) {
                    ...
                    setVisible(false);
                    // Manali
                    DomesticManali frame = new DomesticManali();
                    frame.setVisible(true);
                } else if (place == 3) {
                    setVisible(false);
                    // Kerala (Munnar)
                    DomesticMunnar frame = new DomesticMunnar();
                    frame.setVisible(true);
                } else if (place == 4) {
                    setVisible(false);
                    // Shimla
                    DomesticShimla frame = new DomesticShimla();
                    frame.setVisible(true);
                } else if (place == 5) {
                    setVisible(false);
                    // Darjeeling
                    DomesticDarjeeling frame = new DomesticDarjeeling();
                    frame.setVisible(true);
                } else {

...
public class DomesticDarjeeling extends JFrame {
    ...
    DomesticDarjeeling() {
        ...
        // Title
        label1 = new JLabel();
        label1.setText("3 Packs Available for Darjeeling");

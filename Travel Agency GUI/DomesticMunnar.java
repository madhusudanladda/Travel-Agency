...
public class DomesticMunnar extends JFrame {
    ...
    DomesticMunnar() {
        ...
        // Title
        label1 = new JLabel();
        label1.setText("3 Packs Available for Kerala (Munnar)");
